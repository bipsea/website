		...
		<div class="relative flex flex-col md:flex-row">
			...
			>
				<span class="mx-auto text-xl font-black leading-none text-gray-900 select-none"
					>bipsea<span class="text-indigo-600">.</span></span
				>
			</a>
			<nav
			...
			>
				...
				<a href="/sell" class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">Sell</a
				>
				<a href="/profile" class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900"
					>Profile</a
				>
			</nav>
		</div>
